...
import { ArrowLeft, Calendar, Trophy, Star, Clock, Music } from "lucide-react";
            ...
            <div className="container mx-auto px-6 py-20 relative z-10 min-h-screen flex flex-col">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto w-full">
                    ...
                    <motion.div
                        ...
                        className="opacity-50 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-500 cursor-not-allowed"
                    >
                    ...
                    >
                        <div className="relative h-full bg-transparent border border-dashed border-white/10 rounded-3xl overflow-hidden flex flex-col items-center justify-center p-8 text-center min-h-[300px] hover:border-white/20 transition-colors">
                            <Star className="w-12 h-12 text-white/10 mb-4" />
                            <h3 className="text-xl font-bold text-white/30 mb-2">More Coming Soon</h3>
                            <p className="text-white/20 text-sm">
                                Stay tuned for future tournaments <br />and community challenges.
                            </p>
                        </div>
                    </motion.div>
