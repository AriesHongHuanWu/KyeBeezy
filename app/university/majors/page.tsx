...
export default function MajorsPage() {
    return (
        <div className="container mx-auto px-6 py-24 min-h-screen flex flex-col items-center justify-center text-center">
            <h1 className="text-4xl font-bold text-black dark:text-white mb-4">Academic Programs</h1>
            <p className="text-neutral-500 mb-8">Detailed curriculum usage coming soon.</p>
