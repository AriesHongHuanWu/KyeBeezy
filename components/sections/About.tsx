...
export default function AboutSection() {
    return (
        <section id="about" className="relative min-h-[80vh] flex items-center py-20 overflow-hidden">
            {/* Background elements */}
            <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-purple-900/10 to-transparent pointer-events-none" />
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-black font-outfit tracking-tighter text-white drop-shadow-lg">
                        ...
                        <div className="space-y-4 text-gray-300 text-lg leading-relaxed font-light">
                            <p>
                                Born in the rhythm, raised by the beat. <span className="text-white font-semibold">Kye Beezy</span> isn't just a name; it's a frequency. From streaming sessions that light up the night to tracks that hit the soul, the journey has always been about connection.
                            </p>
                            <p>
